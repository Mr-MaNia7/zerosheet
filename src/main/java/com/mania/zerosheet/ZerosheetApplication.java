...
public class ZerosheetApplication {
	...
	@Bean
	public CommandLineRunner dataSeeder(CustomerRepository custRepo, TransactionRepository transRepo, ItemRepository itemrepo,
		...
		return args -> {
			...
			// FOR TESTING
			// Customer customer = new Customer("A", "B", "C", "ascd@gmail.com", "0914233454", "1122", "AA", 12, 123,
			// 		12345, 123, 12345, 12, 12, 12, 123, 123, 1, "Arada");
			
			// Transaction trans1 = new Transaction(10, new Date(), new Date(), 1L, 23, 21, 12, customer, item1);
